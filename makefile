...
output: main.o win_add_book.o ncurses_my_fun.o info_win.o display.o logic.o
	gcc main.o win_add_book.o ncurses_my_fun.o info_win.o display.o logic.o -o output -lform -lncurses -lmenu 
